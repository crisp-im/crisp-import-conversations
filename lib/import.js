  ...
  __callWithRetry(fn) {
    return fn()
      .catch((error) => {
        ...
        if (_code === 423 || _message === "quota_limit_exceeded") {
          console.warn(`⚠️  Quota limit exceeded (423). Waiting ${RETRY_DELAY}s before retrying...`);

          return temporize(RETRY_DELAY * 1000)
            .then(() => fn());
        }
